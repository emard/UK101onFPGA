...
-- Module  Version: 5.6
--/usr/local/diamond/3.3_x64/ispfpga/bin/lin64/scuba -w -n lattice_pll_25M_50M -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 50 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 

-- Thu Dec 25 10:14:13 2014
...
entity lattice_pll_25M_50M is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of lattice_pll_25M_50M : entity is true;
end lattice_pll_25M_50M;

architecture Structure of lattice_pll_25M_50M is
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of lattice_pll_25M_50M is
    for Structure
