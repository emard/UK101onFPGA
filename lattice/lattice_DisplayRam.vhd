...
end lattice_DisplayRam;

architecture Structure of lattice_DisplayRam is
    ...
    attribute MEM_LPC_FILE of lattice_DisplayRam_0_0_0 : label is "lattice_DisplayRam.lpc";
    attribute MEM_INIT_FILE of lattice_DisplayRam_0_0_0 : label is "";
    attribute CSDECODE_B of lattice_DisplayRam_0_0_0 : label is "0b000";
    attribute CSDECODE_A of lattice_DisplayRam_0_0_0 : label is "0b000";
    attribute WRITEMODE_B of lattice_DisplayRam_0_0_0 : label is "NORMAL";
    attribute WRITEMODE_A of lattice_DisplayRam_0_0_0 : label is "NORMAL";
    attribute GSR of lattice_DisplayRam_0_0_0 : label is "DISABLED";
    attribute RESETMODE of lattice_DisplayRam_0_0_0 : label is "SYNC";
    attribute REGMODE_B of lattice_DisplayRam_0_0_0 : label is "OUTREG";
    attribute REGMODE_A of lattice_DisplayRam_0_0_0 : label is "OUTREG";
    attribute DATA_WIDTH_B of lattice_DisplayRam_0_0_0 : label is "9";
    attribute DATA_WIDTH_A of lattice_DisplayRam_0_0_0 : label is "9";
...
begin
    ...
    lattice_DisplayRam_0_0_0: DP16KB
        -- synopsys translate_off
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of lattice_DisplayRam is
    for Structure
